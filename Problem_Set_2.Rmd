...
Substituting the expectations from the Wald Estimand into this definition, we have:
 ...
 $= \dfrac{(E[Yi|Zi = 1] − E[Yi|Zi = 0])}{(E[Di|Zi = 1] − E[Di|Zi = 0])}$

As $E[Di|Zi = 0] = 0$, we can simplify the denominator to:

 $= \dfrac{E[Yi|Zi = 1] − E[Yi|Zi = 0]}{E[Di|Zi = 1]}$

Therefore, under the LATE assumptions and $E[Di|Zi = 0] = 0$, the Wald Estimand provides an estimate of the Average Treatment Effect on the Treated (ATT).
